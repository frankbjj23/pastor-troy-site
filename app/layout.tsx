...
const title = "Greater Expectation Church | Pastor Troy E. Bazemore";
const description = "Greater Expectation Church is a Christ-centered Baptist church led by Pastor Troy E. Bazemore and Elder Tanisha Bazemore, helping people grow through Scripture, prayer, worship, and fellowship.";
...
export function generateMetadata(): Metadata {
  ...
  return {
    ...
    openGraph: {
      ...
      images: [{ url: socialImageUrl, width: 1672, height: 941, alt: "Greater Expectation Church with Pastor Troy E. Bazemore" }],
    },
